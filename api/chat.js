/**
 * 李首男简历 - AI 问答机器人后端 (Vercel Serverless Function)
 *
 * 流程：
 * 1. 用户提问 → 2. 查百炼知识库 → 3. 把结果给 DeepSeek V4 → 4. 返回回答
 */
...
1. 2025.08 - 2025.12 | 沈阳天童美语 | 营销推广与私域运营（ToC）
   工作职责：负责沈阳核心商圈及大型幼儿园等场所的地推拓客，通过精准人群画像分析，日均高效触达目标家长群体，实现公域流量向私域的转化；负责潜在客户群体的长期维护，通过提供高价值内容提升社群活跃度与信任度；每周六独立/协助组织线下家长学生联动活动。
   收获：沉淀了扎实的一线面销技巧与抗压能力，深刻理解ToC消费心理学；掌握了从"线下地推-社群沉淀-活动裂变-深度促活"的全链路私域运营闭环思维。
   离职原因：完成学业

2. 2024.10 - 2025.06 | 博宇金属贸易公司 | ToB大客户销售（期货/跟单）
   工作职责：通过行业展会、专业论坛、宏观新闻及产业研报深度挖掘潜在企业级客户，利用电话销售精准触达；负责ToB工业品销售、大宗商品期货交易与全流程跟单；定期进行客户电访与回访。
   收获：培养了敏锐的行业宏观经济与期货市场分析能力；掌握了ToB大客户开发流转、商务合同谈判、风险控制及全周期跟单管理的硬核技能。
   离职原因：身体原因无法适应长期省外出差和酒席应酬

3. 2026.01 - 2026.02 | 锦书教育 | 在线教育销售与直播运营
   工作职责：面向已购低价/体验课学员进行线上直播授课，通过高效课堂互动与价值锚定激发学员兴趣；配合直播节点，通过电话对家长进行深度回访与需求诊断，促成高价正价课的加购与二次转化。
   收获：跑通了在线教育"直播带货/高转化授课 + 电话精准社群催单"的复合型销售模式；提升了线上公众表达、临场应变能力及精细化用户生命周期管理（LTV）意识。
   离职原因：合同短期工

4. 2024.01 - 2024.09 | 罗森（沈阳）| 区域零售门店运营与供应链协同
   工作职责：深度参与辽宁省内多家直营及加盟门店的日常经营管理；运用ERP系统实时动态监控商品数据，精细化统计临期损耗与畅销品类，执行高效的跨店转货调拨；参与规划并落地零售门店的日常促销、会员礼品管理及重大节假日主题活动，实现门店销售额（GMV）与会员复购率稳步增长。
   收获：积累了极强的新零售实体店运营经验、面销技巧及敏锐的数据看板分析能力；深刻理解了大型连锁零售业态的商品全生命周期管理、物流转配与供应链跨部门协同机制。
   离职原因：非正式实习

5. 2023.07 - 2023.10 | 久屹机械制造有限公司 | 市场拓展与技术协调（实习生）
   工作职责：负责向工业级客户讲解、演示公司机械产品，针对不同客户的生产业务场景进行定制化产品推荐；充当市场与生产技术端的纽带，精准翻译并反馈客户的非标定制需求给生产研发部门，跟踪协调技术方案落地。
   收获：了解了工业制造企业的运作架构，掌握了企业内部跨部门（销售-生产-技术）交接协同与复盘流程；提升了将客户痛点转化为产品技术语言的跨界沟通与项目协调能力。
   离职原因：实习期结束

【校园经历】
- 2020.09 - 2026.06 | 沈阳师范大学 市场营销（本科）
- 班级团支部书记、校团委第二课堂部部长
- 荣誉奖项：连续三次荣获校级奖学金（累计1400元）

- 信息化项目开发与运营（第二课堂部部长任期）：
  核心主导：由本人牵头并协调学校团委老师、技术团队，从0到1共同开发并上线了"沈师青课堂"APP。深入参与该系统二课考核标准的编纂与顶层设计，将APP内的学分考核与学生毕业资质深度挂钩，实现全校学生高频次活跃与刚性覆盖。

- 基层组织与公益策划（团支部书记任期）：
  作为班级核心骨干，具备极强的号召力。在校期间统筹并组织多次大型志愿者活动、爱心献血以及疫情期间校园志愿服务，累计服务时长超百小时。

- 多元社会实践（大一至大三）：
  在校期间勇于走出舒适圈，先后尝试了摆摊、后厨、搬家、家教、店员、外卖、进厂等10余种跨界兼职工作。积累了极其深厚的底层社会经验，掌握了针对不同阶层、不同背景人群的跨沟通技巧，培养了极强的抗压能力与同理心。

- 知行合一的深度实践（大四至大六）：
  主动选择进行长达两年的"GAP式"高强度社会实习，将市场营销理论在ToB/ToC多条商业赛道中全面内化。

【核心主修课程】
管理学、微观经济学、宏观经济学、统计学、市场营销学、销售管理、广告学、消费者行为学、物流管理、会计学基础、财务管理
...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      if (br.ok) {
        ...
        if (d.output && d.output.text) {
          knowledgeContext = d.output.text;
          console.log("✅ 百炼知识库查询成功");
        }
      } else {
        console.log(`⚠️ 百炼返回 ${br.status}`);
      }
    } catch (e) {
      console.log(`⚠️ 百炼查询失败: ${e.message}`);
    }
    ...
    if (!dr.ok) {
      ...
      console.error(`❌ DeepSeek 错误: ${dr.status}`);
      throw new Error(`AI 服务暂时不可用 (${dr.status})`);
    }
